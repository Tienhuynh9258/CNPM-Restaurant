        ...
        <div class="second">
            ...
            <div class="card orderCard">
                ...
                <div class="cardHeader row">
                    <div class="col-6">
                        <h4>Mã đơn: <?php echo e($order->ID); ?></h4>
                    </div>

                    <div class="col-6">
                        <button type="button" class="btn btn-danger detail" data-bs-toggle="modal"
                            data-bs-target="#myModal<?php echo e($order->ID); ?>">Chi tiết</button>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-12">
                        <p class="dishList">
                            <?php $__currentLoopData = $foodOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $food): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($order->ID == $food->ORDER_ID): ?>
                            <i class="material-icons">restaurant</i> <?php echo e($food->FNAME); ?><br>
                            <?php endif; ?>
            ...
            <!-- The Modal -->
            <div class="modal fade" id="myModal<?php echo e($order->ID); ?>">
                <div class="modal-dialog modal-dialog-scrollable modal-md">
                    <div class="modal-content">

                        <!-- Modal Header -->
                        <div class="modal-header">
                            <h5 class="modal-title text-center">Mã đơn: <?php echo e($order->ID); ?></h5>
                        ...
                        <div class="modal-body dishes">
                            ...
                            <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="modalCol">
                                            <img class="mx-auto d-block" src="<?php echo e(asset($food->IMAGE_URL)); ?>" alt="Food image"
                                                style="width:80%">
                                    ...
                                    <div class="col-8">
                                        <p class="modalCol">
                                            ...
                                            <span class="boldText">Ghi chú:</span> <?php echo e($food->DESCRIPT); ?><br>
                                        </p>
                                    </div>
...
</html><?php /**PATH F:\CNPM-Restaurant\source_code\resources\views/RecvOrder.blade.php ENDPATH**/ ?>