    ...
    <body>
        <div class="contain">
            ...
            <div class="nav">
                ...
                <div class="signout"><a href="<?php echo e(route('home')); ?>">Thoát <i class="fas fa-sign-out-alt" aria-hidden="true"></i></a>
                </div>
            </div>
            <!-- navagation -->
<!-- main View -->
...
<?php /**PATH D:\Programs\New folder\htdocs\new\CNPM-Restaurant\source_code\resources\views/admin.blade.php ENDPATH**/ ?>