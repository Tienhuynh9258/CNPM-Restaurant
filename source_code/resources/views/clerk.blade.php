...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/clerk.css') }}">
...
<main id = 'main'>
    ...
    <div class="d-flex flex-column flex-shrink-0 bg-dark fixed-bar">
        ...
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            ...
            <li>
            <a href="{{ route('chat_box', [session()->get('cid'), session()->get('cus_name'), session()->get('staff_type')]) }}" class="nav-link py-3 border-bottom" title="Message" data-bs-toggle="tooltip" data-bs-placement="right" style="color:#ff4757">
            <svg class="bi" width="30" height="30" role="img" aria-label="Message"><use xlink:href="#message"/></svg>
            </a>
            </li>
        </ul>
        <div class="dropdown border-top">
            ...
            <img src="{{ asset('images/logo.jpg') }}" alt="mdo" width="24" height="24" class="rounded-circle">
            </a>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $.each(msg, function(key, val){
            ...
            {
                output += '<div class = "order-board"><div class="text-center"><button onclick="openDetail('+val.ID+')" class="openbtn btn btn-primary w-100" style="background-color: #747d8c;">'+val.STATUS+'</button><h6>Order số</h6><h5>'+val.ID+'</h5></div></div>';
            }
            else if(val.STATUS == "Đã thanh toán")
            {
                output += '<div class = "order-board"><div class="text-center"><button id="btn-open-detail" class="openbtn btn btn-primary w-100" style="background-color: #7bed9f;" onclick="openDetail('+val.ID+')">'+val.STATUS+'</button><h6>Order số</h6><h5>'+val.ID+'</h5></div></div>';
            }
            else if(val.STATUS == "Chưa nấu")
            {
                output += '<div class = "order-board"><div class="text-center"><button class="openbtn btn btn-primary w-100" style="background-color: #3742fa;" onclick="openDetail('+val.ID+')">'+val.STATUS+'</button><h6>Order số</h6><h5>'+val.ID+'</h5></div></div>';
            }
            else if(val.STATUS == "Đang nấu")
            {
                output += '<div class = "order-board"><div class="text-center"><button class="openbtn btn btn-primary w-100" style="background-color: #ffa502;" onclick="openDetail('+val.ID+')">'+val.STATUS+'</button><h6>Order số</h6><h5>'+val.ID+'</h5></div></div>';
            }
            else
            {
                output += '<div class = "order-board"><div class="text-center"><button class="openbtn btn btn-primary w-100" style="background-color: #7bed9f;" onclick="openDetail('+val.ID+')">'+val.STATUS+'</button><h6>Order số</h6><h5>'+val.ID+'</h5></div></div>';
            }
        });
        return output;
    }
