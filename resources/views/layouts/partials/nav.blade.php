<nav class="navbar navbar-expand-lg bg-light p-0 fixed-top">
    <ul class="navbar-nav text-muted" id='menu-list'>
        ...
        @if(session()->has('uname'))
          <li class="nav-item">
            <a class="nav-link" href="javascrip:void(0)" data-toggle="modal" title="Personal information." id='customer-info' data-target="#update-customer-form">Hello, {{session()->get('uname')}}</a>
          </li>
          <li class="nav-item">
